...
function doSomething() {
	...
	console.log(board);
	document.getElementById('EYPL8e').innerHTML = '<span style="color:white; position: absolute;top: 15px; right: 40px;">&lt/><span>' + document.getElementById('EYPL8e').innerHTML;
}
