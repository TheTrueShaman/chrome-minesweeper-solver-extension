...
function doSomething() {
	...
	console.log(board);
	document.getElementById('EYPL8e').innerHTML = '<span style="color:white; position: absolute;top: 10px; right: 110px; font-size:25px">&lt/></span>' + document.getElementById('EYPL8e').innerHTML;
}
